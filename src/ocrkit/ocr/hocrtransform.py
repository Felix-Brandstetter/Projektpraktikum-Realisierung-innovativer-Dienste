...
class HocrTransform:
    ...
    # hocr.to_pdf(out_filename, tiff_image, font_color, show_bounding_boxes, interword_spaces)
    def _to_pdf(
        self,
        *,
        out_filename: Path,
        tiff_image: Path | None = None,
        fontcolor: str,
        ...
        Arguments:
            ...
            tiff_image: Image to use for this file. If omitted, the OCR text
                is shown.
        ...
        if tiff_image is not None:
            pdf.drawImage(
                os.fspath(tiff_image), 0, 0, width=self.width, height=self.height
            )
    ...
    def _do_line(
        ...
        pdf.setFillColor(fontcolor)  # text in black
